...
function(ko) {
  ...
  var Utils = function() {
      ...
      self.ENDPOINT = 'http://api.atmosplay.com/';
      self.GESTURE_LOADING_TIME = 500;
      self.SKIP_CORRENCT_ENDTIME_SUPPORTER = 100;
      self.GESTURE_IMAGE_BASE_URL = "http://atmosplay.com/webclient/assets/images/gestures/";
      self.IMAGE_BASE_URL = "http://atmosplay.com/webclient/assets/images/";
      self.BASE_URL = self.ENDPOINT + "game/";
      self.VIDEO_BASE_URL = "http://demos.atmosplay.com/";
