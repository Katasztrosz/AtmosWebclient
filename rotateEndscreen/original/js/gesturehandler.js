      ...
      self.isSwipeDirectionOk = function (ev, direction) {
        ...
        switch (ev.direction) {
          case 2:
            ...
            return (direction == 270 || direction == 200);
          case 4:
            console.log('rightswipe');
            return (direction == 90 || direction == 200);
          case 8:
            console.log('upswipe');
            return (direction == 0 || direction == 100);
          case 16:
            console.log('downswipe');
            return (direction == 180 || direction == 100);
          default:
            return false;
        }
      };  
